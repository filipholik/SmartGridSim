...
def smartGridSimNetwork():
    ...
    info( '*** Starting hosts \n')
    DSS1RTU = net.addHost('DSS1RTU', cls=Host, ip='1.1.1.1', defaultRoute='1.1.10.10',mac='00:00:00:00:00:06')
    DSS2RTU = net.addHost('DSS2RTU', cls=Host, ip='1.1.2.1', defaultRoute='1.1.10.10',mac='00:00:00:00:00:07')
    CONTROL = net.addHost('CONTROL', cls=Host, ip='1.1.10.10', defaultRoute='1.1.1.1',mac='00:00:00:00:00:08')
    IED1 = net.addHost('IED1', cls=Host, ip='1.1.3.1', defaultRoute='1.1.10.10',mac='b4:b1:5a:0a:b4:ef')
    IED2 = net.addHost('IED2', cls=Host, ip='1.1.3.2', defaultRoute='1.1.10.10',mac='00:00:00:00:00:02')
    IED3 = net.addHost('IED3', cls=Host, ip='1.1.3.3', defaultRoute='1.1.10.10',mac='00:00:00:00:00:03')
    IED4 = net.addHost('IED4', cls=Host, ip='1.1.3.4', defaultRoute='1.1.10.10',mac='00:00:00:00:00:04')
    DPSHMI = net.addHost('DPSHMI', cls=Host, ip='1.1.3.10', defaultRoute='1.1.10.10',mac='00:00:00:00:00:05')
    ATTACKER = net.addHost('ATTACKER', cls=Host, ip='1.1.3.66', defaultRoute='1.1.10.10',mac='00:00:00:00:00:66')

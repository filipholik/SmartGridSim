...
def smartGridSimNetwork():
    ...
    IED1 = net.addHost('IED1', cls=Host, ip='1.1.3.1', defaultRoute='1.1.10.10',mac='b4:b1:5a:0a:b4:01')
    IED2 = net.addHost('IED2', cls=Host, ip='1.1.3.2', defaultRoute='1.1.10.10',mac='b4:b1:5a:00:00:02')
    IED3 = net.addHost('IED3', cls=Host, ip='1.1.3.3', defaultRoute='1.1.10.10',mac='00:30:A7:00:00:03')
    IED4 = net.addHost('IED4', cls=Host, ip='1.1.3.4', defaultRoute='1.1.10.10',mac='00:30:A7:00:00:04')
    DPSHMI = net.addHost('DPSHMI', cls=Host, ip='1.1.3.10', defaultRoute='1.1.10.10',mac='00:80:BC:00:00:05')
    ATTACKER = net.addHost('ATTACKER', cls=Host, ip='1.1.3.66', defaultRoute='1.1.10.10',mac='00:06:5B:00:00:66')
